...
void setupCleanOldNamespacesToolsJob(String jobFolder) {
    def jobParams = getJobParams('kogito-clean-old-namespaces', jobFolder, 'Jenkinsfile.clean-old-namespaces')
    jobParams.triggers = [ cron : '@midnight' ]
    KogitoJobTemplate.createPipelineJob(this, jobParams)
}

void setupCleanOldNightlyImagesToolsJob(String jobFolder) {
    jobParams = getJobParams('kogito-clean-old-nightly-images', jobFolder, 'Jenkinsfile.clean-nightly-images')
...
void setupPrepareReleaseJob(String jobFolder) {
    KogitoJobTemplate.createPipelineJob(this, getJobParams('prepare-release', jobFolder, 'Jenkinsfile.release-prepare', 'Prepare env for a release')).with {
        parameters {
